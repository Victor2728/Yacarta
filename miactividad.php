...
$CantidadMostrar=5;
$aid = mysqli_real_escape_string($link,$_GET['id']);
     // Validado  la variable GET
    $compag         =(int)(!isset($_GET['pag'])) ? 1 : $_GET['pag']; 
  $TotalReg       =mysqli_query($link,"SELECT * FROM publicaciones WHERE usuario = '$aid'");
          ...
          <div class="box box-widget">
            ...
            while($com=mysqli_fetch_array($comentarios)){
              ...
              <br>
                ...
                <input type="text" class="enviar-btn form-control input-sm" style="width: 760px;" placeholder="Escribe un comentario" name="comentario" id="comentario-<?php  echo $lista['id_pub'];?>">
