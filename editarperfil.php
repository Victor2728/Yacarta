...
$miuser = mysqli_query($link,"SELECT * FROM usuarios WHERE id_use = '$id'");
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          if(isset($_POST['actualizar']))
          {
            ...
            $nacimiento = mysqli_real_escape_string($link,$_POST['nacimiento']);
            if($nacimiento != '') {$nac = $nacimiento;} else {$nac = $use['nacimiento'];}

            $comprobar = mysqli_num_rows(mysqli_query($link,"SELECT * FROM usuarios WHERE usuario = '$usuario' AND id_use != '$id'"));
            if($comprobar == 0){
            ...
            $sql = mysqli_query($link,"UPDATE usuarios SET nombre = '$nombre', usuario = '$usuario', email = '$email', sexo = '$sexo', nacimiento = '$nac', avatar = '$nombrea' WHERE id_use = '$id'");
        ...
        <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php $registrados = mysqli_query($link,"SELECT avatar,usuario,fecha_reg FROM usuarios order by id_use desc limit 8");
