...
<header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Ya</b>Carta</span>
    </a>

    <!-- Header Navbar: style can be found in header.less -->
    <?php
          $link = mysqli_connect("127.0.0.1","root","","yacarta");
          $noti = mysqli_query($link,"SELECT * FROM notificaciones WHERE user2 = '".$_SESSION['id']."' AND leido = '0' ORDER BY id_not desc");
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                $users = mysqli_query($link,"SELECT * FROM usuarios WHERE id_use = '".$no['user1']."'");
                $usa = mysqli_fetch_array($users, MYSQLI_ASSOC);
                ?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="avatars/<?php echo $_SESSION['avatar']; ?>" width="50" alt="User Image" class = "img-circle">
        </div>
