              ...
              <!-- /.box-body -->
                <div class="box-footer">
                  ...
                  if(isset($_POST['publicar'])) 
                  {
                    ...
                    $result = mysqli_query($link,"SHOW TABLE STATUS WHERE `Name` = 'publicaciones'");
                    ...
                    $llamar = mysqli_num_rows(mysqli_query($link,"SELECT * FROM albumes WHERE usuario ='".$_SESSION['id']."' AND nombre = 'Publicaciones'"));

                    if($llamar >= 1) {} else {

                    $crearalbum = mysqli_query($link,"INSERT INTO albumes (usuario,fecha,nombre) values ('".$_SESSION['id']."',now(),'Publicaciones')");

                   }

                   $idalbum = mysqli_query($link,"SELECT * FROM albumes WHERE usuario ='".$_SESSION['id']."' AND nombre = 'Publicaciones'");
                   $alb = mysqli_fetch_array($idalbum);

                    $subirimg = mysqli_query($link,"INSERT INTO fotos (usuario,fecha,ruta,album,publicacion) values ('".$_SESSION['id']."',now(),'$nombre','".$alb['id_alb']."','$next_increment')");

                    $llamadoimg = mysqli_query($link,"SELECT id_fot FROM fotos WHERE usuario = '".$_SESSION['id']."' ORDER BY id_fot desc");
                    ...
                    $subir = mysqli_query($link,"INSERT INTO publicaciones (usuario,fecha,contenido,imagen,album,comentarios) values ('".$_SESSION['id']."',now(),'$publicacion','".$llaim['id_fot']."','".$alb['id_alb']."','1')");
        ...
        <div class="col-md-4">          
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <?php 
              $link = mysqli_connect("127.0.0.1","root","","yacarta");
              $amistade = mysqli_query($link ,"SELECT * FROM amigos WHERE para = '".$_SESSION['id']."' AND estado = '0' order by id_ami desc LIMIT 4");
              while($am = mysqli_fetch_array($amistade)) { 

                $use = mysqli_query($link,"SELECT * FROM usuarios WHERE id_use = '".$am['de']."'");
        ...
        <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php 
                  $link = mysqli_connect("127.0.0.1","root","","yacarta");
                  $Consulta= "SELECT avatar,usuario,fecha_reg FROM usuarios order by id_use desc limit 8";
                  $registrados = mysqli_query($link,$Consulta);
                  while($reg=mysqli_fetch_array($registrados,MYSQLI_ASSOC)) 
                  {
                  ?>
                    <li>
