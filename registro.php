...
$nombre = mysqli_real_escape_string($link, $_POST['nombre']);
      ...
      $resultado = mysqli_query($link,"SELECT usuario FROM usuarios WHERE usuario = '$usuario'");
      $resultado2 = mysqli_query($link,"SELECT email FROM usuarios WHERE email = '$email'");

    
      $comprobarusuario = mysqli_num_rows($resultado);
      $comprobaremail = mysqli_num_rows ($resultado2);
     ...
     <?php } else {
        ...
        <?php } else {
          ...
          <?php } else {
            ...
            $insertar = mysqli_query($link,"INSERT INTO usuarios (nombre,email,usuario,contrasena,fecha_reg,avatar) values ('$nombre','$email','$usuario','$contrasena',now(),'defect.jpg')");
